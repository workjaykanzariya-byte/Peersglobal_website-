  ...
  return (
    <div className="min-h-screen bg-[#030B1C] text-slate-900 selection:bg-blue-600 selection:text-white">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <section className="relative py-20 sm:py-28 bg-white text-slate-900 border-t border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-base text-slate-600 max-w-2xl mx-auto font-light leading-relaxed mb-16">
          ...
          <div className="relative mb-16">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4 lg:gap-3 items-stretch">
              {LEADERSHIP_PATHWAY.map((item, idx) => {
                ...
                return (
                  <div key={idx} className="relative flex flex-col items-center">
                    ...
                    {/* Node Card */}
                    <div className="w-full bg-[#F8FAFC] rounded-2xl p-4 border border-slate-200/80 shadow-sm flex flex-col items-center text-center h-full hover:border-[#0062D2]/40 transition-colors">
                      {/* Icon Circle */}
                      <div className={`size-12 rounded-full flex items-center justify-center mb-3 shadow-xs border ${item.badgeColor}`}>
                    ...
                    {idx < LEADERSHIP_PATHWAY.length - 1 && (
                      <div className="hidden lg:flex absolute -right-3 top-1/2 -translate-y-1/2 z-10 text-slate-300 pointer-events-none">
                        <ChevronRight className="size-5 text-slate-400/80" />
                      </div>
                    )}
                  </div>
                )
          ...
          {/* Quote & Explore Button */}
          <div className="max-w-2xl mx-auto text-center">
            <p className="font-serif italic text-base sm:text-lg text-slate-700 leading-relaxed mb-8">
