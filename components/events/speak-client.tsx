    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A1A1A] antialiased">
      ...
      <div className="border-b border-[#EADFC7]/60 bg-[#FAF6EE]/90 backdrop-blur-md sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center gap-2 text-xs text-neutral-600">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-neutral-400" />
          <span className="text-neutral-900 font-semibold">Speak at Peers Global</span>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#FAF4E8] border border-[#E8DFC9] text-xs font-bold uppercase tracking-wider text-[#8C6422]">
                <Mic className="w-3.5 h-3.5 text-[#8C6422]" />
                STAGE &amp; MASTERCLASSES
              </div>
      ...
      <section className="py-14 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Who we book */}
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-emerald-200/80 shadow-2xs space-y-4">
              ...
              <p className="text-base font-serif italic text-[#2B3B5E] font-medium">
                People who have done the thing.
              </p>

              <ul className="space-y-3 text-xs sm:text-sm text-neutral-700 leading-relaxed">
            ...
            {/* Who we do not book */}
            <div className="p-6 sm:p-8 rounded-2xl bg-[#FFFBFB] border border-rose-200/80 shadow-2xs space-y-4">
              <div className="flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={idx}
                className="p-5 rounded-2xl bg-white border border-[#E8DFC9] shadow-2xs space-y-2"
              >
      ...
      <section className="py-12 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-6 sm:p-8 rounded-2xl bg-white border border-[#EADFC7] shadow-xs flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#FAF4E8] border border-[#E8DFC9] text-xs sm:text-sm font-bold text-[#8C6422] hover:bg-[#F3EADB] transition-all uppercase tracking-wider shrink-0"
            >
      ...
      <section id="external-speaker-form" className="py-16 border-b border-[#EADFC7]/60 bg-[#FAF7F0]/60">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="text-center space-y-2">
            <span className="text-xs font-bold uppercase tracking-wider text-[#0D6EFD]">
              Direct Application
            </span>
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#142038]">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-neutral-700">Organisation / Business *</label>
                    <input
                      type="text"
                      required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-neutral-700">Subject / Topic *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-neutral-700">What have you personally built? *</label>
                  <textarea
                    rows={3}
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-neutral-700">Relevant Experience *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-neutral-700">Message / Key Takeaways for the Room</label>
                  <textarea
                    rows={3}
