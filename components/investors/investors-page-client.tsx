        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
            {VERIFIED_METRICS.map((metric) => (
              <div
                key={metric.label}
                className="p-6 rounded-3xl bg-white border border-slate-200/80 shadow-sm text-center space-y-2 hover:shadow-md transition-shadow"
              >
                <div className="text-3xl sm:text-4xl font-serif font-bold text-[#0062D2]">
                  {metric.value}
                </div>
                <div className="text-xs font-serif font-bold text-[#061836]">
                  {metric.label}
                </div>
          ...
          <div className="p-8 sm:p-12 md:p-16 rounded-3xl bg-white border border-slate-200/80 shadow-md space-y-8">
            ...
            {isSubmitted ? (
              <div className="p-10 rounded-2xl bg-blue-50/60 border border-blue-200 text-center space-y-4">
                ...
                <h3 className="text-2xl font-serif font-bold text-[#061836]">Enquiry Logged</h3>
