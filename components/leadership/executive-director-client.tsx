          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 z-10">
              ...
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-xl">
                Area. District. State. Country. Wherever you hold, the
                entrepreneurial ecosystem inside it becomes your responsibility.
              </p>
            ...
            <div className="lg:col-span-6 relative">
              <div className="relative w-full h-[420px] sm:h-[480px] lg:h-[520px] rounded-3xl overflow-hidden shadow-2xl">
                {/* Background Image: Executive on high-rise terrace overlooking city sunrise */}
                <Image
                  src="/images/executive-director-hero.jpg"
                ...
                {/* Soft gradient fade on the left edge blending seamlessly into page background */}
                ...
                <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-slate-950/60 to-transparent pointer-events-none z-10" />

                {/* Sky Text in upper right */}
                <div className="absolute top-6 right-6 text-right z-20 max-w-[260px]">
                  <p className="text-xl sm:text-2xl font-serif font-bold text-slate-900 leading-tight drop-shadow-[0_2px_10px_rgba(255,255,255,0.9)]">
                    Stronger Regions.
                  </p>
                  <p className="text-lg sm:text-xl font-serif font-semibold text-slate-800 leading-tight drop-shadow-[0_2px_10px_rgba(255,255,255,0.9)] mt-0.5">
                    Stronger Entrepreneurs.
                  </p>
                  <p
                    className="text-base sm:text-lg font-light italic text-[#0062D2] leading-tight drop-shadow-sm mt-1"
