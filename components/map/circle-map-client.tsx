    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A1A1A] antialiased">
      ...
      <div className="border-b border-[#EADFC7]/60 bg-[#FAF6EE]/90 backdrop-blur-md sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center gap-2 text-xs text-neutral-600">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-neutral-400" />
          <span className="text-neutral-900 font-semibold">The Map</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-[#D5C7B0]/60 bg-[#050C18] group">
                <div className="relative h-72 sm:h-80 w-full overflow-hidden">
                  <Image
                    ...
                    priority
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#050C18] via-transparent to-[#050C18]/40" />
                  ...
                  <div className="absolute bottom-6 right-6 z-10 text-right">
                    <p className="font-serif italic text-white/95 text-lg sm:text-xl drop-shadow-lg leading-tight">
                      Real People.
                      <br />
                      <span className="text-[#D4AF37]">Real Communities.</span>
                      <br />
                      A Global Movement.
                    </p>
                  </div>
          ...
          {/* 5 Stats Row */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 pt-10 mt-10 border-t border-[#EADFC7]/70">
            {[
              ...
              >
                ...
                <div>
                  <span className="block text-lg sm:text-xl font-serif font-bold text-neutral-900 leading-tight">
                    {item.label}
                  </span>
      ...
      <section className="py-10 border-b border-[#EADFC7]/60 bg-[#FAF7F0]/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-xl bg-white border border-[#D5C7B0] text-xs sm:text-sm placeholder:text-neutral-400 focus:outline-none focus:border-[#0D6EFD]"
              />
            </div>
          ...
          <div className="relative w-full h-[480px] sm:h-[540px] rounded-2xl bg-[#EAF2F8] border border-[#D5C7B0] overflow-hidden shadow-inner flex items-center justify-center">
            ...
            {[
              ...
              >
                <span className="relative flex h-5 w-5 items-center justify-center">
                  ...
                  <span className="relative inline-flex rounded-full h-3 w-3 bg-[#0D6EFD] border-2 border-white shadow" />
                </span>
              </button>
            ))}

            {/* Interactive Selected City Card Modal (Ahmedabad) */}
            <div className="absolute right-4 sm:right-10 top-1/2 -translate-y-1/2 w-80 sm:w-96 rounded-2xl bg-white/95 backdrop-blur-md border border-[#D5C7B0] shadow-2xl p-5 z-20 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 py-2 border-y border-[#E8DFC9] text-center">
                <div>
                  <span className="block text-lg font-serif font-bold text-neutral-900">
                    {selectedCity.circles}
                  </span>
                  <span className="text-[11px] text-neutral-500">Circles</span>
                </div>
                <div>
                  <span className="block text-lg font-serif font-bold text-neutral-900">
                ...
                <div>
                  ...
                  <span className="text-[11px] text-neutral-500">Since</span>
                </div>
              </div>

              <Link
                href={`/circles?city=${selectedCity.name.toLowerCase()}`}
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#0D6EFD] text-white text-xs sm:text-sm font-bold hover:bg-blue-600 transition-colors uppercase tracking-wider"
              >
                View Circles
                <ArrowRight className="w-4 h-4" />
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <div className="inline-flex p-1 rounded-xl bg-neutral-200/60 border border-[#D5C7B0] mt-2">
            ...
            <Link
              href="/cities"
              className="text-[#0D6EFD] font-bold text-xs sm:text-sm hover:underline inline-flex items-center gap-1"
            >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {FEATURED_CITIES.map((city, idx) => (
              <Link
                ...
                className="group rounded-2xl bg-white border border-[#E8DFC9] overflow-hidden shadow-2xs hover:shadow-md transition-all flex flex-col"
              >
                ...
                <div className="p-3 space-y-1 text-[11px]">
                  <div className="flex items-center justify-between text-neutral-600">
                    ...
                    <span className="font-bold text-neutral-900">{city.members}+</span>
                  </div>
                </div>
              </Link>
            ))}
      ...
      <section className="py-12 border-b border-[#EADFC7]/60 bg-[#FAF7F0]/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-[#EADFC7] shadow-xs flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-blue-50 text-[#0D6EFD] flex items-center justify-center shrink-0 border border-blue-100">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#0D6EFD] text-white text-xs font-bold hover:bg-blue-600 transition-all uppercase tracking-wider"
                  >
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-[#EADFC7] shadow-xs flex items-start gap-4">
              <div className="w-12 h-12 rounded-xl bg-amber-50 text-[#8C6422] flex items-center justify-center shrink-0 border border-amber-100">
              ...
              <div className="space-y-3">
                ...
                <div>
                  <Link
                    href="/international"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-[#D5C7B0] text-xs font-bold text-neutral-800 hover:bg-[#F4EFE6] transition-all uppercase tracking-wider"
                  >
                    View International
                    <ArrowRight className="w-3.5 h-3.5" />
                  </Link>
