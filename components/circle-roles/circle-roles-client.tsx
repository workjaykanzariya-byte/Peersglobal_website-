    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A1A1A] font-sans selection:bg-[#E8DDD0] selection:text-[#1A1A1A]">
      ...
      <div className="border-b border-[#EADFC7]/50 bg-[#FDFBF7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center gap-2 text-xs text-neutral-500 font-medium">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-neutral-400" />
          <span className="text-neutral-900 font-semibold">Roles Inside a Circle</span>
        </div>
      </div>
      ...
      <section className="py-16 md:py-24 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div>
            ...
            <p className="text-sm text-neutral-600 mt-1 font-serif italic">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Circle Founder Card */}
            <div className="p-8 rounded-3xl bg-white border border-[#E8DFC9] shadow-sm flex flex-col sm:flex-row gap-6 items-start">
              <div className="relative w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-2 border-[#D8C7A5] bg-[#E8DDD0] shrink-0">
                <Image
            ...
            <div className="p-8 rounded-3xl bg-white border border-[#E8DFC9] shadow-sm flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="space-y-3 flex-1">
                ...
                <div className="p-2.5 rounded-xl bg-[#FAF6EE] border border-[#EADBBD] text-xs font-serif italic text-[#8C6422]">
      ...
      <section className="py-16 md:py-24 border-b border-[#EADFC7]/60 bg-[#FAF7F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-7 rounded-3xl bg-white border border-[#E5DAC0] shadow-sm space-y-6 flex flex-col justify-between">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Responsible for what the Circle produces.</p>
                  </div>
                </div>

                <div className="space-y-3.5 pt-2 text-xs text-neutral-600 divide-y divide-[#F0E6D2]">
                  <div className="pt-2">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Responsible for who is in the room.</p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">Responsible for what the Circle does beyond meetings.</p>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-24 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-9 gap-4">
            {PROJECT_CHAIRS.map((pc) => {
              ...
              return (
                <div
                  key={pc.name}
                  className="p-5 rounded-2xl bg-white border border-[#E8DFC9] shadow-xs text-center space-y-2.5 flex flex-col items-center justify-center hover:border-blue-400 transition-all"
                >
          ...
          <div className="p-6 sm:p-7 rounded-3xl bg-[#FAF7F0] border border-[#E5DAC0] flex items-start gap-4 shadow-xs">
            ...
            <div className="space-y-1 text-xs sm:text-sm text-neutral-700 leading-relaxed">
              <strong className="block text-neutral-900 font-bold">Why they exist:</strong>
