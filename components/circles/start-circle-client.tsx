  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-[#0F172A] selection:bg-[#0062D2] selection:text-white font-sans">
      ...
      {/* =================================================================
          SECTION 9: APP STRIP
          ================================================================= */}
      <section className="py-10 bg-[#0062D2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div>
              <p className="text-white font-bold text-lg sm:text-xl">Explore the community before you apply.</p>
              <p className="text-white/70 text-sm mt-1">Download the Unity App and see how the network works from the inside.</p>
            </div>
            <div className="flex flex-wrap gap-3 shrink-0">
              <a
                href="https://play.google.com/store"
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm font-semibold transition-all"
              >
                <svg viewBox="0 0 24 24" className="size-5 fill-current"><path d="M3.18 23.76c.37.21.8.22 1.19.06L16.91 12 4.37.18C3.98.02 3.55.03 3.18.24 2.46.65 2 1.44 2 2.31v19.38c0 .87.46 1.66 1.18 2.07z"/></svg>
                Google Play
              </a>
              <a
