    ...
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A1A1A] font-sans selection:bg-[#E8DDD0] selection:text-[#1A1A1A]">
      ...
      <div className="border-b border-[#EADFC7]/50 bg-[#FDFBF7]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center gap-2 text-xs text-neutral-500 font-medium">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-neutral-400" />
          <span className="text-neutral-900 font-semibold">Peers Global Marketplace</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[#EADFC7]/70">
                <div>
                  <span className="block text-2xl font-bold font-serif text-[#1A1A1A]">100%</span>
                  <span className="text-xs text-neutral-500">Contribution-backed</span>
                </div>
                <div>
                  <span className="block text-2xl font-bold font-serif text-[#8C6422]">0₹</span>
                  <span className="text-xs text-neutral-500">Zero cash purchases</span>
                </div>
                <div>
                  <span className="block text-2xl font-bold font-serif text-[#1A1A1A]">5 Core</span>
                  <span className="text-xs text-neutral-500">Redemption categories</span>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-3xl bg-gradient-to-br from-[#1E2530] via-[#141A23] to-[#0D1117] text-white p-8 md:p-10 shadow-2xl border border-neutral-700/60 overflow-hidden">
                ...
                <div className="space-y-6 relative z-10">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <span className="text-[10px] tracking-wider uppercase text-neutral-400 font-semibold block">Member Wallet</span>
                        <span className="text-sm font-semibold text-neutral-200">Unity Digital Ledger</span>
                      </div>
                    </div>
                  ...
                  <div className="p-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm space-y-2">
                    ...
                    <div className="flex items-baseline gap-2">
                      <span className="text-4xl font-serif font-bold text-amber-300">320</span>
                      <span className="text-xs font-semibold uppercase tracking-wider text-neutral-300">Peers Coin</span>
                    </div>
                  ...
                  <div className="space-y-2.5 text-xs text-neutral-300">
                    <div className="flex items-center justify-between py-1.5 border-b border-white/10">
                      <span className="text-neutral-400">Redemption Fee</span>
                      <span className="font-semibold text-emerald-400">0% (Nil)</span>
                    </div>
                    <div className="flex items-center justify-between py-1.5 border-b border-white/10">
                      <span className="text-neutral-400">Delivery / Access</span>
                      <span className="font-semibold text-white">Instant in Unity App</span>
                    </div>
                    <div className="flex items-center justify-between py-1.5">
                      <span className="text-neutral-400">Cash Top-Up</span>
      ...
      <section className="py-16 md:py-24 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {/* Growth Tools */}
            <div className="p-6 rounded-2xl bg-white border border-[#E8DFC9] hover:border-[#8C6422] transition-all space-y-3 flex flex-col justify-between shadow-2xs">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-serif font-bold text-[#1A1A1A]">Growth Tools</h3>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#E8DFC9] hover:border-[#8C6422] transition-all space-y-3 flex flex-col justify-between shadow-2xs">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-serif font-bold text-[#1A1A1A]">Learning</h3>
                <p className="text-xs text-neutral-600 leading-relaxed">
                  Masterclasses, workshops and practical programmes led by top peers across the global community.
                </p>
              </div>
              <span className="text-[11px] font-semibold text-blue-700 block pt-2 border-t border-neutral-100">
                Cohorts & Sprints
              </span>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#E8DFC9] hover:border-[#8C6422] transition-all space-y-3 flex flex-col justify-between shadow-2xs">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-serif font-bold text-[#1A1A1A]">Experiences</h3>
                <p className="text-xs text-neutral-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#E8DFC9] hover:border-[#8C6422] transition-all space-y-3 flex flex-col justify-between shadow-2xs">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-serif font-bold text-[#1A1A1A]">Business Resources</h3>
                <p className="text-xs text-neutral-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white border border-[#E8DFC9] hover:border-[#8C6422] transition-all space-y-3 flex flex-col justify-between shadow-2xs">
              <div className="space-y-3">
                ...
                <h3 className="text-base font-serif font-bold text-[#1A1A1A]">Merchandise</h3>
                <p className="text-xs text-neutral-600 leading-relaxed">
      ...
      <section className="py-16 md:py-24 border-b border-[#EADFC7]/60 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            {/* Step 1 */}
            <div className="p-6 rounded-2xl bg-[#FDFBF7] border border-[#E8DFC9] space-y-4 relative">
              <div className="w-10 h-10 rounded-xl bg-[#FAF3E0] border border-[#E6D4AA] flex items-center justify-center font-serif font-bold text-lg text-[#8C6422]">
                01
              </div>
              <h3 className="text-base font-serif font-bold text-[#1A1A1A]">1. Give</h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-[#FDFBF7] border border-[#E8DFC9] space-y-4 relative">
              ...
              <h3 className="text-base font-serif font-bold text-[#1A1A1A]">2. It is confirmed</h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-[#FDFBF7] border border-[#E8DFC9] space-y-4 relative">
              ...
              <h3 className="text-base font-serif font-bold text-[#1A1A1A]">3. You earn coins</h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-[#FDFBF7] border border-[#E8DFC9] space-y-4 relative">
              ...
              <h3 className="text-base font-serif font-bold text-[#1A1A1A]">4. You redeem</h3>
              <p className="text-xs text-neutral-600 leading-relaxed">
      ...
      <section className="py-16 md:py-20 border-b border-[#EADFC7]/60 bg-[#FAF5EB]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <div className="pt-2">
            <Link
              href="/peers-coin"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white border border-[#D5C7B0] text-neutral-900 text-xs sm:text-sm font-semibold hover:bg-neutral-100 transition-colors shadow-2xs"
            >
      ...
      <section className="py-16 md:py-24 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <Link
              href="/unity"
              className="inline-flex items-center gap-2 text-xs sm:text-sm font-bold text-[#0D6EFD] hover:text-blue-700 transition-colors"
            >
          ...
          {/* Filter Pills */}
          <div className="flex flex-wrap gap-2 pt-2 border-b border-[#EADFC7]/60 pb-4">
            <button
            ...
            {filteredItems.map((item) => (
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-bold uppercase tracking-wider text-[#8C6422] bg-amber-50 px-2.5 py-1 rounded-md border border-amber-200/60">
                      {item.categoryLabel}
                    </span>
                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#1A1A1A] text-white text-xs font-bold font-mono">
                  ...
                  <div>
                    ...
                    {item.badge && (
                      <span className="inline-block mt-1 text-[10px] font-bold text-blue-700 bg-blue-50 border border-blue-200 px-2 py-0.5 rounded">
                        {item.badge}
                      </span>
                    )}
                  </div>
                ...
                <div className="pt-4 border-t border-neutral-100 flex items-center justify-between">
                  ...
                  <Link
                    href="/unity"
                    className="inline-flex items-center gap-1 text-xs font-bold text-[#0D6EFD] hover:text-blue-700 transition-colors"
                  >
                    Redeem in Unity
