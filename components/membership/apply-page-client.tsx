                  ...
                  {isCompleted ? (
                    ...
                    <div className="py-10 text-center space-y-6 animate-in fade-in zoom-in-95 duration-300">
                      ...
                      <div className="pt-2 flex flex-col sm:flex-row justify-center gap-3">
                        <Link
                          href="/unity"
                          className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#0062D2] hover:bg-blue-700 text-white font-bold text-xs shadow-md transition-all"
                        >
                        ...
                        <button
                          ...
                          className="px-6 py-3 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-xs transition-all"
                        >
                        ...
                        <div className="space-y-3.5 animate-in fade-in duration-200">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <button
                              ...
                              className="flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-full border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold shadow-xs transition-all"
                            >
                        ...
                        <div className="space-y-3.5 animate-in fade-in duration-200">
                          ...
                          <div className="pt-2 flex items-center justify-between gap-3">
                            <button
                              ...
                              className="px-5 py-2.5 rounded-full border border-slate-200 bg-slate-50 hover:bg-slate-100 text-xs font-bold text-slate-600 transition-all"
                            >
                              Back
                            </button>
                            <button
