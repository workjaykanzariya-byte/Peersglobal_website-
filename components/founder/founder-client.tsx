    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="relative bg-[#040E24] text-white py-24 md:py-32 overflow-hidden border-t border-slate-900">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <p className="text-2xl sm:text-3xl md:text-4xl font-serif italic text-sky-300 leading-snug max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            <Link
              href="/unity"
              className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl bg-[#0062D2] text-white text-sm font-bold hover:bg-[#0052B4] transition-all shadow-lg hover:shadow-xl active:scale-[0.98]"
            >
              Download Unity App
              <ArrowRight className="w-4 h-4" />
            </Link>
