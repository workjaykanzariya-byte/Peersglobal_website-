    ...
    <div className="min-h-screen bg-[#FBFCFE] text-slate-900 font-sans selection:bg-blue-100 selection:text-slate-900">
      ...
      <div className="border-b border-slate-200/80 bg-white/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center gap-2 text-xs text-slate-500 font-medium">
          ...
          <ChevronRight className="w-3.5 h-3.5 text-slate-400" />
          <span className="text-slate-900 font-semibold">How a Circle Works</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-4 p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex flex-col items-center justify-between text-center space-y-6">
              <div>
                <h3 className="text-xl font-serif text-[#0D1F47] font-bold">
                  A Circle Seat Map
                </h3>
              ...
              <div className="relative w-64 h-64 mx-auto my-auto flex items-center justify-center">
                {/* Central Hub */}
                <div className="w-28 h-28 rounded-full bg-[#0D1F47] text-white flex flex-col items-center justify-center shadow-lg z-10 p-2">
                ...
                {[
                  ...
                  <div
                    ...
                    className={`absolute ${node.pos} px-2.5 py-1 rounded-full text-[10px] font-semibold border ${
                      node.isOpen
                        ? 'bg-white border-dashed border-[#0062D2] text-[#0062D2] shadow-sm animate-pulse'
              ...
              <p className="font-serif italic text-xs text-[#0062D2] pt-2 font-semibold">
      ...
      <section className="py-16 md:py-24 border-b border-slate-200/80 bg-[#FAF7F0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3.5 text-xs text-slate-600">
                  <div className="p-3.5 rounded-2xl bg-[#FAF7F0] border border-slate-200">
                    <strong className="block text-slate-900 font-bold mb-1">Twelve meetings a year</strong>
                    A fixed schedule, published well in advance, so busy owners plan around it.
                  </div>
                  <div className="p-3.5 rounded-2xl bg-[#FAF7F0] border border-slate-200">
                    <strong className="block text-slate-900 font-bold mb-1">The same people, every time</strong>
                    This is the mechanism. Trust needs repetition, and repetition needs a calendar.
                  </div>
                  <div className="p-3.5 rounded-2xl bg-[#FAF7F0] border border-slate-200">
                    <strong className="block text-slate-900 font-bold mb-1">The same agenda</strong>
            ...
            <div className="lg:col-span-4 p-8 rounded-3xl bg-white border border-slate-200/90 shadow-sm flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between text-xs font-mono text-slate-500 border-b border-slate-200 pb-3">
                  <span className="font-bold text-[#0062D2]">Meeting 1</span>
                  <span>Meeting 2</span>
                  <span>Meeting 3</span>
                  <span className="text-slate-400">...</span>
                  <span className="font-bold text-slate-900">Meeting 12</span>
                </div>

                <div className="space-y-2.5">
                  <div className="p-3 rounded-xl bg-[#FAF7F0] border border-slate-200 text-xs">
                    <strong className="block text-[#0062D2] font-bold">Peer-to-Peer Meetings</strong>
                    <span className="text-slate-500 text-[11px]">(One to One deep dives outside the room)</span>
                  </div>

                  <div className="p-3 rounded-xl bg-[#FAF7F0] border border-slate-200 text-xs">
                    <strong className="block text-emerald-600 font-bold">Unity App (All Year)</strong>
                    <span className="text-slate-500 text-[11px]">Share requirements • Make introductions • Log contributions</span>
                  </div>

                  <div className="p-3 rounded-xl bg-[#FAF7F0] border border-slate-200 text-xs">
                    <strong className="block text-purple-600 font-bold">Follow-through</strong>
                    <span className="text-slate-500 text-[11px]">Conversations turn into confirmed collaborations</span>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div>
                <h2 className="text-3xl font-serif text-[#0D1F47] font-bold">
                  Joining a Circle
                </h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {[
                  { step: '1', title: 'Apply on Portal', desc: 'Complete your registration and start your profile' },
                  ...
                  >
                    <span className="w-7 h-7 rounded-full bg-[#0062D2] text-white text-xs font-bold flex items-center justify-center">
                      {st.step}
                    </span>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/apply"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-[#0062D2] hover:bg-[#1a42c0] text-white text-xs font-bold shadow-md transition-all uppercase tracking-wider"
                >
                  Apply to Join <ArrowRight className="w-3.5 h-3.5" />
                </Link>
                <Link
                  href="/circles"
                  className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-white text-slate-800 text-xs font-bold border border-slate-200 hover:bg-slate-50 transition-all shadow-xs"
                >
            ...
            <div className="lg:col-span-5 relative rounded-3xl overflow-hidden bg-[#0B1220] text-white p-8 sm:p-10 shadow-xl border border-slate-800">
              ...
              <div className="relative z-10 space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-sm font-serif italic text-amber-300 leading-relaxed font-normal">
