      ...
      <section className="relative bg-[#0062D2] text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <div className="pt-4 flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/unity"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white/10 text-white text-sm font-semibold border border-white/20 hover:bg-white/20 transition-all uppercase tracking-wider backdrop-blur-sm"
            >
              Download Unity App
            </Link>
          </div>
