    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <section className="relative pt-12 pb-16 md:pt-16 md:pb-24 overflow-hidden bg-gradient-to-b from-[#EFF6FF] via-[#F8FAFC] to-[#FFFFFF] border-b border-slate-200/80">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6 relative z-10">
          <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-white/90 border border-blue-200 shadow-2xs text-xs font-bold uppercase tracking-[0.22em] text-[#0062D2] mx-auto">
            <Handshake className="w-3.5 h-3.5 text-[#0062D2]" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {PARTNER_CATEGORIES.map((item) => {
              ...
              return (
                <div
                  key={item.title}
                  className="p-8 rounded-3xl bg-white border border-slate-200/80 shadow-sm space-y-4 hover:shadow-xl hover:border-blue-300 hover:-translate-y-1 transition-all duration-300 group"
                >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {PARTNERSHIP_MODELS.map((model) => (
              <div
                key={model.title}
                className="p-7 rounded-3xl bg-white border border-slate-200/80 shadow-sm space-y-2"
              >
                <h3 className="text-xl font-serif font-bold text-[#061836]">
                  {model.title}
                </h3>
            ...
            <div className="p-7 rounded-3xl bg-blue-50/70 border border-blue-200 flex flex-col justify-between space-y-4">
              <div>
                <h3 className="text-xl font-serif font-bold text-[#061836]">Sponsorship Opportunities</h3>
      ...
      <section className="py-20 md:py-28 bg-white border-b border-slate-200/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-12 md:p-16 rounded-3xl bg-[#061836] text-white shadow-xl space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-4 text-base sm:text-lg text-slate-300 leading-relaxed font-light">
              <p className="text-xl sm:text-2xl font-serif text-sky-300 italic font-normal">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 items-center">
            {[
              ...
              <div
                key={partner}
                className="p-6 rounded-2xl bg-white border border-slate-200/80 shadow-sm flex items-center justify-center text-center text-sm font-serif font-semibold text-slate-800 h-24 hover:border-blue-300 transition-colors"
              >
                {partner}
              </div>
            ))}
      ...
      <section id="enquiry-form" className="py-20 md:py-28 bg-white border-b border-slate-200/80">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="p-8 sm:p-12 md:p-16 rounded-3xl bg-white border border-slate-200/80 shadow-md space-y-8">
            ...
            {isSubmitted ? (
              <div className="p-10 rounded-2xl bg-blue-50/60 border border-blue-200 text-center space-y-4">
                ...
                <h3 className="text-2xl font-serif font-bold text-[#061836]">Partnership Brief Submitted</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-2">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2.5 px-9 py-4 rounded-xl bg-[#0062D2] text-white text-sm font-bold hover:bg-[#0052B4] transition-all shadow-md hover:shadow-lg disabled:opacity-50 active:scale-[0.98]"
                  >
