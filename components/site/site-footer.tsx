...
export function SiteFooter() {
  ...
  // 6 Balanced, Spacious Columns for Clear Readability & 15px+ Typography
  const FOOTER_COLUMNS = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Circle Experience', href: '/circle-meeting-experience' },
    ...
    {
      title: 'Leadership & Currency',
      links: [
        { label: 'The Leadership Ladder', href: '/leadership' },
        { label: 'Board of Advisory', href: '/leadership/advisory-board' },
        ...
        { label: 'Peers Coin & Standing', href: '/peer-standing' },
