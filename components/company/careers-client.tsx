...
export function CareersClient() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#1A1A1A] antialiased">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-5">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#FAF4E8] border border-[#E8DFC9] text-xs font-bold uppercase tracking-wider text-[#8C6422]">
                <Briefcase className="w-3.5 h-3.5 text-[#8C6422]" />
                JOIN THE MISSION
              </div>
      ...
      <section className="py-14 border-b border-[#EADFC7]/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-[#EADFC7] shadow-xs space-y-4">
              <h2 className="text-2xl font-serif font-bold text-[#142038]">
                Who we hire
              </h2>
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-white border border-[#EADFC7] shadow-xs space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs text-neutral-600 pt-1">
                <span className="flex items-center gap-1.5">
                  <Users className="w-3.5 h-3.5 text-[#0D6EFD]" /> Community Ops
                </span>
                <span className="flex items-center gap-1.5">
                  <Code className="w-3.5 h-3.5 text-[#0D6EFD]" /> Technology
                </span>
                <span className="flex items-center gap-1.5">
                  <Video className="w-3.5 h-3.5 text-[#0D6EFD]" /> Media &amp; Content
                </span>
                <span className="flex items-center gap-1.5">
                  <Palette className="w-3.5 h-3.5 text-[#0D6EFD]" /> Product Design
                </span>
                <span className="flex items-center gap-1.5">
                  <HeartHandshake className="w-3.5 h-3.5 text-[#0D6EFD]" /> Partnerships
                </span>
                <span className="flex items-center gap-1.5">
                  <Headphones className="w-3.5 h-3.5 text-[#0D6EFD]" /> Member Support
                </span>
              </div>
            </div>
          </div>
      ...
      {/* ─── Open Roles ─── */}
      <section id="open-roles" className="py-14 border-b border-[#EADFC7]/60 bg-[#FAF7F0]/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {OPEN_ROLES.map((role, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl bg-white border border-[#E8DFC9] shadow-2xs hover:shadow-md transition-shadow space-y-4 flex flex-col justify-between"
              >
                <div className="space-y-2">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-[11px] font-mono font-bold uppercase text-[#8C6422] bg-[#FAF4E8] px-2.5 py-0.5 rounded-md border border-[#E8DFC9]">
                      {role.department}
                    </span>
                ...
                <div className="pt-3 border-t border-[#E8DFC9] flex items-center justify-between text-xs">
                  <span className="text-neutral-500">{role.location}</span>
                  <a
                    href="#general-application"
                    className="text-[#0D6EFD] font-bold hover:underline inline-flex items-center gap-1"
                  >
      ...
      <section id="general-application" className="py-16 border-b border-[#EADFC7]/60">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white border border-[#E8DFC9] shadow-sm">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-[#D5C7B0] text-sm focus:outline-none focus:border-[#0D6EFD]"
                    />
                  </div>
                  <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <label className="text-xs font-semibold text-neutral-700">Area of Interest *</label>
                    <select
                      value={formData.roleInterest}
                      onChange={(e) => setFormData({ ...formData, roleInterest: e.target.value })}
                      className="w-full px-3.5 py-2.5 rounded-xl border border-[#D5C7B0] text-sm focus:outline-none focus:border-[#0D6EFD] bg-white"
                    >
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-neutral-700">Portfolio, GitHub or LinkedIn URL *</label>
                  <input
                    type="url"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-semibold text-neutral-700">What have you finished and built? *</label>
                  <textarea
                    rows={4}
                    required
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-3.5 rounded-xl bg-[#0D6EFD] text-white text-xs sm:text-sm font-bold hover:bg-blue-600 transition-all uppercase tracking-wider shadow-md shadow-blue-500/20 flex items-center justify-center gap-2"
                  >
                    Submit Application
