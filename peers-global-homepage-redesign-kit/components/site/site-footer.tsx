...
export function SiteFooter() {
  ...
  return (
    <div className="w-full font-sans antialiased">
      ...
      {/* ========================================================================= */}
      <section className="w-full bg-white border-t border-[#e6e6e6] py-10 px-4 sm:px-8 lg:px-12">
        <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
          {/* Left: Statement + App Badges */}
          <div className="flex flex-col gap-3 max-w-2xl text-center lg:text-left items-center lg:items-start">
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#0067b8]">
              The Core Conviction
            </span>
            <h2 className="text-2xl sm:text-3xl font-bold text-[#242424] tracking-tight leading-tight">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-[2px] bg-[#111111] hover:bg-[#242424] text-white px-4 py-2 text-xs font-semibold transition-colors shadow-xs"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-[2px] bg-[#111111] hover:bg-[#242424] text-white px-4 py-2 text-xs font-semibold transition-colors shadow-xs"
              >
                <Smartphone className="size-4 text-[#e5b850]" />
                <div className="text-left leading-tight">
          ...
          {/* Right: Email Capture */}
          <div className="w-full lg:w-auto min-w-[320px] sm:min-w-[400px] flex flex-col gap-2 bg-[#f8f9fa] p-5 sm:p-6 rounded-[4px] border border-[#e6e6e6]">
            <div className="flex items-center gap-2">
              <Mail className="size-4 text-[#0067b8]" />
            ...
            {subscribed ? (
              <div className="flex items-center gap-2 text-xs font-semibold text-[#0e7039] bg-[#eaf5ea] p-2.5 rounded-[2px] border border-[#bce2bc] mt-2">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 mt-2">
                <input
                  ...
                  className="w-full rounded-[2px] border border-[#8a8a8a] px-3 py-2 text-xs text-[#242424] placeholder:text-[#737373] focus:outline-none focus:border-[#0067b8] transition-colors"
                />
                <button
                  type="submit"
                  className="whitespace-nowrap rounded-[2px] bg-[#0067b8] hover:bg-[#005a9e] text-white px-4 py-2 text-xs font-semibold transition-colors shrink-0 shadow-xs"
                >
                  Subscribe
                </button>
              </form>
