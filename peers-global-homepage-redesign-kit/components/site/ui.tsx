...
const ctaBase =
  'inline-flex items-center justify-center gap-2 font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ring)] disabled:opacity-50'

const ctaVariants: Record<CtaVariant, string> = {
  primary: 'bg-primary text-primary-foreground hover:bg-primary/90',
  gold: 'bg-gold text-[#1a1405] hover:bg-gold/90',
  red: 'bg-brand-red text-white hover:bg-brand-red/90',
  outline: 'border border-[var(--border)] bg-transparent text-foreground hover:bg-muted',
  onDark: 'border border-white/25 bg-transparent text-white hover:bg-white/10',
...
export function SectionHead({
  ...
  return (
    ...
    >
      ...
      <h2
        className={cn(
          'display text-pretty text-2xl sm:text-3xl lg:text-[2.5rem] font-semibold tracking-tight leading-snug',
