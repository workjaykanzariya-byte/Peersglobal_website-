...
export function HomeHero() {
  ...
  return (
    <section className="relative min-h-[92vh] overflow-hidden bg-[#050B17] text-white border-b border-white/10">
      {/* Cinematic Looping Earth Video at bottom left */}
      <div className="pointer-events-none absolute -bottom-28 sm:-bottom-44 -left-12 sm:-left-20 z-0 h-[600px] w-[750px] sm:h-[780px] sm:w-[980px] lg:h-[920px] lg:w-[1200px] overflow-hidden">
        <video
          ...
          muted
          playsInline
          poster="/images/navbar-earth-bg.jpg"
          className="size-full object-cover object-left-bottom opacity-85 mix-blend-screen scale-105"
        />
        {/* Cinematic gradient fade overlays so video borders seamlessly merge into #050B17 */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#050B17]/60 via-[#050B17]/20 to-[#050B17] pointer-events-none" />
        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#050B17]/30 to-[#050B17] pointer-events-none" />
      </div>
        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:gap-12">
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <div className="flex items-center gap-3">
              <span className="h-px w-8 bg-cyan-400/80 shadow-[0_0_8px_#38bdf8]" />
            ...
            {/* H1 Heading */}
            <h1 className="text-4xl sm:text-5xl lg:text-[3.65rem] font-medium tracking-tight text-white leading-[1.12] drop-shadow-md">
              Build Your Business.
              <br />
